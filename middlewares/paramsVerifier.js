...
const userInParams = async (req, res, next) => {
    try{
        ...
        return res.status(500).send({
            message : "Internal server error while reading the user info"
        })
    }
}
...
const theatreInParams = async (req, res, next) => {
    try{
        ...
        if(!theatre){
            return res.status(400).send({
                message : "Theatre id doesn't exist"
            })
        }
        ...
        return res.status(500).send({
            message : "Internal server error while reading the theatre info"
        })
    }
}
...
const movieInParams = async (req, res, next) => {
    try{
        ...
        console.log("#### Error while reading movie info ####")
        return res.status(500).send({
            message : "Internal server error while reading movie info"
        })
    }
}
