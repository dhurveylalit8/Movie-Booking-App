...
exports.failedTicketPayment = (userEmail, payment) => {
    sendEmail(
        ...
        `The payment of your movie booking for amount ${payment.amount} has been failed. Please create a new booking from ${notificationConfig.appURL}/mba/api/v1/bookings`,
        `${userEmail}`,
        "Movie Booking App"
    );
}
